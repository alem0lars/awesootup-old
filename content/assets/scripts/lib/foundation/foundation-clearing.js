      ...
      cl = {
        init: function (options, extendMethods) {
          return this.find('ul[data-clearing]').each(function () {
            ...
            if (!settings) {
              ...
              $el.data('fndtn.clearing.settings',
        ...
        assemble: function ($li) {
          var $el = $li.parent(),
              ...
              grid = $el.detach(),
              data = {
                grid: '<div class="carousel">' + this.outerHTML(grid[0])
                    + '</div>',
        ...
        direction: function ($el, current, target) {
          var lis = $el.find('li'),
              ...
              up_count = Math.floor($('.clearing-container').outerWidth()
                  / li_width) - 1,
          ...
          if (this.adjacent(defaults.prev_index, target_index)) {
            if ((target_index > up_count) && target_index
                > defaults.prev_index) {
              response = 'right';
